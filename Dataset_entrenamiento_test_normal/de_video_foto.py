...
cap = cv2.VideoCapture("man_2_normal.mp4")
 
 # Crea un archivo para guardar el fotograma del video
save_path = os.makedirs("man2_normal") #con makedirs, mkdir si existe lanza error, con exist_ok=true chancas
...
while True:
	...
	if sum % time == 0 and i < 5000:
		...
		imgPath = "man2_normal/33%s.jpg" % str(i)
